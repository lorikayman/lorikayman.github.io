...
<span slot="desc">A supreme email, calendar, chat, and assistant enterprise-grade desktop client to excel in an intense office workflow through application of UX accumulated over the last 2 decades of email clients' developments</span>
