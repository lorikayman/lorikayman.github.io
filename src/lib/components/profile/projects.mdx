...
<span slot="desc">A supreme email, chat, and assistant enterprise-grade desktop client based of Mozilla Thunderbird</span>

<span slot="date">██.2024 - ...</span>
<div slot="did">
...
- Rework and creating of Mozilla Mach CLI components
  ...
  - Intergration of Mozilla Policies specification into packaging pipeline
...
- Development of design guidelines for Web UI of the control panel
  - UI and UX research, study, composition and development of VanillaJS and KnockoutJS 3 components-backed Bootstrap 4 administation panel based on industries WebUI best practices
  - Continius support and further migration of frontend technology
...
- Implimentation of architecture for various part of the pipeline (i.e. parsing, tokenization)
