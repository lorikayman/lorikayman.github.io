<script>
  import CorporateIntroduction from "./corporate_introduction.mdx";
...
A legal obligation to position following text as part of hosting on the __Communications Array__ and being and employee of HHGC.
...
__Following information is gathered from the personnel file:__

<ProjectEntry>
<span slot="name">Desktop H</span>
...
<ProjectEntry>
<span slot="name">HH WarpMail</span>
...
<ProjectEntry>
<span slot="name">HH Remote</span>
<span slot="date">05.2019 - 07.2019</span>
<span slot="desc">Linux-based VDI infrastructure</span>
<div slot="did">
...
- Installation of a physical server hosting templated KVM/QEMU VMs with GPUs passed into them
...
<ProjectEntry>
<span slot="name">HH Recover</span>
<span slot="date">09.2018 - 05.2019</span>
<span slot="desc">Windows Backup, replication and storage infrastructure</span>
<div slot="tech">

- VEEAM Backup and replication infrastructure installation, support, maintenance and integration into MS VMM-managed cluster inside of an AD forest. Part of the infrastructure required to support backup and replication, automatic hot and cold storage management of templated Windows VMs
...
- VM and hardware networking, access to DMZ over MikroTik with pFSence solution
...
<div use:melt={$root} id="first-of-projects">
  ...
  <div use:melt={$content} class="danger">
    ...
    `- Detected MITM-type interception ...`

    `- Detected presence of an invalid narrative representation within a web-component ...`

    `- Deploying Narraphysic Isolation Environment ...`

    `- Narraphysic Isolation Environment has been successfully deployed,
      targeted intercepted narrative representation is captured within
