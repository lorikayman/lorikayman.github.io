...
Salt Sarcophaguses of <Link path="/mawanet/ekhinill">Ekhinill</Link> are sealed chambers of alchemically mummified <Link path="/mawanet/maelstrom_watchtower_network">Operators</Link>-<Link path="/mawanet/revenant">revenants</Link> which maintain <Link path="/mawanet/kinetic_neurosymbolics">neurosymbolic</Link> meaning of <Link path="/mawanet/runes">runes</Link> in order for them to preserve internal energy similar to <Link path="/mawanet/hordholl">hordholl</Link> crystalls.
