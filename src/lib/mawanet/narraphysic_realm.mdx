...
> This state of conceptual existence which persists seemingly independently, or rather, below, of a concrete physics emerging from a concrete vacuum is the narraphysic realm.
>
> A terrifying implication of consciousness preceeding matter.

Narraphysic realm at it's most abstract form is a phenomenon caused, presumably, by the <Link path="/mawanet/engine_of_narraphysic_gliding">engine of narraphysic gliding</Link> as a native environment for <Link path="/mawanet/narrative">narratives</Link> and a concept of <Link path="/mawanet/acropolis">Acropolis</Link> to be manifested within the vacuum's civilisations, resulting in a reality posessing a conceptual layer of existance which is formed with the moment a vacuum is manifested into existence.

At it's core, narraphysic realm tethers together concept of unit of information and a concept of energy - an lattuce of fields of <Link path="/mawanet/perception_particle">perception particles</Link>, <Link path="/mawanet/memetic_field">memetic field</Link> being once of the closest to a concept of noosphere, being percieved by a conscious mind in a form of collective unconceousness.

In case of a current <Link path="/mawanet/standard_reality">standard reality</Link> Narraphysic Realm is manifested as an ecosystem of ideas/concepts/<Link path="/mawanet/narrative">narratives</Link> and comprising them <Link path="/mawanet/narreme">narremes</Link>-<Link path="/mawanet/resonance">resonances</Link>. This approach is seemingly placing authority of sentience over existence itself, it is more plausible due to voluntary nature of <Link path="/mawanet/malevelent_presence">malevelent presence</Link>/<Link path="/mawanet/acropolis">Acropolis</Link> concept being integrated within a vacuum.

### Hierarchy

The `A ← B` relation shows the comprisement of smaller entities' group on it's right (B) and a high-order entity made of this group on the left (A):

- <Link path="/mawanet/conceptual_configuration">conceptual configuration</Link> ← <Link path="/mawanet/narrative">narrative</Link> ← <Link path="/mawanet/narreme">narreme</Link>-<Link path="/mawanet/resonance">resonance</Link> ← Cosmic string or brane
- <Link path="/mawanet/conceptual_configuration">conceptual configuration</Link> ← <Link path="/mawanet/narrative">narrative</Link> ← (<Link path="/mawanet/resonance">resonance</Link> ← <Link path="/mawanet/narrative">narrative</Link>)ad infinitum ← <Link path="/mawanet/narreme">narreme</Link>-<Link path="/mawanet/resonance">resonance</Link>
- <Link path="/mawanet/conceptual_configuration">conceptual configuration</Link> ← <Link path="/mawanet/conceptual_configuration">conceptual configuration</Link>
